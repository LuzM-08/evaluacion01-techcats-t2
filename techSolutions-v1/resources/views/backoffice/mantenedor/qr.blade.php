...
@section('title', 'Proyecto IPSS | ' . $titulo['singular'])
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <table id="qrs-table" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($registros as $registro)
                            <tr>
                                ...
                                <td><label class="badge badge-dark">{{ $registro->proyecto_nombre }}</label></td>
                                <td><label class="badge badge-primary">{{ $registro->etiqueta }}</label></td>
                                <td style="text-align: center">
                                    <img id="QR{{ $registro->id }}"
                                        onclick="copiarContenido('{{ ($registro->id) }}')" alt="qr"
                                        style="width: 50px; height: auto;" class="swalDefaultSuccess">
                                </td>
                                <td><a href="{{ $registro->redireccion }}" target="_blank"><i class="fa fa-link"></i></a>
                                    {{ $registro->redireccion }}</td>
        ...
        <div class="p-3">
            <div class="row mb-2">
                ...
                <div class="col-2 text-end btn-cerrar">
                    <i id="close-add-qr" class="fa fa-times-circle"></i>
                </div>
            </div>
        ...
        function open_modal(_id, _accion) {
            ...
            switch (_accion) {
                ...
                case 'editar':
                    ...
                    propiedades.form.action = @json(route('qrs.update', 'xxx')).split('xxx')[0] + _id;
                ...
                case 'encender':
                    ...
                    propiedades.form.action = @json(route('qrs.enable', 'xxx')).split('xxx')[0] + _id;
                    propiedades.form.method = 'post';
                ...
                case 'apagar':
                    ...
                    propiedades.form.action = @json(route('qrs.disable', 'xxx')).split('xxx')[0] + _id;
                    propiedades.form.method = 'post';
                ...
                case 'eliminar':
                    ...
                    propiedades.form.action = @json(route('qrs.delete', 'xxx')).split('xxx')[0] + _id;
                    propiedades.form.method = 'post';
