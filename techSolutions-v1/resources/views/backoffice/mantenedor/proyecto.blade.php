        ...
        function open_modal(_id, _accion) {
            ...
            switch (_accion) {
                ...
                case 'editar':
                    ...
                    propiedades.form.action = @json(route('proyectos.update', 'xxx')).split('xxx')[0] + _id;
                ...
                case 'encender':
                    ...
                    propiedades.form.action = @json(route('proyectos.enable', 'xxx')).split('xxx')[0] + _id;
                    propiedades.form.method = 'post';
                ...
                case 'apagar':
                    ...
                    propiedades.form.action = @json(route('proyectos.disable', 'xxx')).split('xxx')[0] + _id;
                    propiedades.form.method = 'post';
                ...
                case 'eliminar':
                    ...
                    propiedades.form.action = @json(route('proyectos.delete', 'xxx')).split('xxx')[0] + _id;
                    propiedades.form.method = 'post';
