...
<head>
    ...
    <title>Proyecto IPSS | Registrar</title>
...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="text-center mt-4">
            <b>Desarrollo Web I</b><br>IPSS<br>&copy; 2023 ~ 2024
        </div>
    </div>
    <!-- /.login-box -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3>General</h3>
                    <p>Esta página aplicación web es propiedad y está operado por el Centro de Modelamiento Matemático.
                        Estos
                    ...
                    <p>
                        Esta aplicación web ofrece a los visitantes la posibilidad de crear códigos QR para insertar en
